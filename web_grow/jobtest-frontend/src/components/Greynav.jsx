...
function Greynavbar() {
  ...
  return (
    <>
      <div
        className={`flex justify-between items-center h-20  mx-auto  px-6  md:px-10 lg:px-20 text-black bg-grey cursor-pointer font-roboto shadow-gl  z-50 ${
          scrolled
            ? "fixed top-0 w-full shadow-md bg-grey backdrop-blur-md  bg-opacity-10"
            : "bg-grey shadow-lg"
        } `}
      >
      ...
      {nav && (
        <div className="fixed left-0 top-0 w-[60%] h-full border-r border-r-gray-900 bg-grey text-black ease-in-out duration-300 z-50">
